...
# The folowing code builts graphs for figure 7 A/B/C using following source files:
#Figure 7A - FC above 1 per tissue in AUT UPS Chap and SYN consortium.csv
#FC bellow 1 per tissue in AUT UPS Chap and SYN consortium.csv

#Figure 7B - TS score per tissue in AUT UPS Chap and SYN all tissues TS TE.csv

#Figure 7C - preferential FC above 2 per tissue in AUT UPS Chap and SYN cell line names.csv
